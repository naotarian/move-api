...
return new class extends Migration
{
    ...
    {
        Schema::create('moving_to_addresses', function (Blueprint $table) {
            ...
            // インデックス
            $table->index('estimate_id', 'idx_moving_to_addresses_estimate_id');
            $table->index(['prefecture', 'zipcode'], 'idx_moving_to_addresses_location');
            $table->index('prefecture_code', 'idx_moving_to_addresses_prefecture_code');
            $table->index('region_code', 'idx_moving_to_addresses_region_code');
            $table->index(['region_code', 'prefecture_code'], 'idx_moving_to_addresses_region_prefecture');
        });
    }
    ...
    {
        Schema::dropIfExists('moving_to_addresses');
    }
};
